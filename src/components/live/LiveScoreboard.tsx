...
const BIRTHDAY_VOICE: PersonalityVoice = {
  ...
  idle: () => pick([
    ...
    "Albertito, vos mirás el partido por zoom? Yo lo miro de verdad. Es una cuestión de eficiencia",
    "Me ponen al lado de un expresidente procesado. Gracias admin por el regalo de cumple",
    "Albertito dice que heredó un prode sin comodín. Yo heredé un comodín sin Alberto y estoy mejor",
    "Que Albertito opine de fútbol es como que yo opine de la fiesta de Olivos. Ah no, pará...",
    "Alberto, si querés te hago un certificado médico para justificar ese pronóstico",
