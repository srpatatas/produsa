  ...
  "R16": { // El Profe Alfiki
    ...
    lecture: {
      ...
      USA: [
        ...
        "Estados Unidos tiene los recursos de una potencia mundial. Pero en el fútbol, la potencia sin control no sirve. Hay que saber canalizar",
        "Los americanos construyen rascacielos. Pero el fútbol no se construye de arriba para abajo. Se construye desde la tierra. Desde la tierra colorada",
      ],
      BEL: [
        ...
        "Bélgica es la consecuencia de la consecuencia. Tienen todo para ganar y siempre les falta algo. Lo que les falta es lo que no se compra: la mística",
      ...
      BRA: [
        ...
        "Brasil es el único país que jugó todos los mundiales. Esa presencia perfecta es un arma y una carga. La carga de la historia pesa como un átomo de Einstein",
