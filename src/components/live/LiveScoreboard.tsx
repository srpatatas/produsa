...
const VOICES: Record<string, PersonalityVoice> = {
  ...
  "R32": { // Albertito
    ...
    idle: () => pick([
      ...
      "El Doctor festeja el cumple y yo acá laburando de comodín. Guardo conmigo el dolor",
      "Feliz cumple, Doctor. Le regalo un comodín. No como la vacuna que le di a los demás",
      "Me bardea un libertario en mi propio programa. Algunos miserables no tienen códigos",
      "El Doctor vota a Milei y después me pide que le comente el partido. La contradicción humana",
      "Dice que es matemáticamente imposible. Eso decían de mi presidencia y mirá, llegué",
      "Doctor, yo fui presidente. Vos ponés comodines. No somos lo mismo",
      "El Doctor y yo coincidimos en algo: el admin cobra mucho y trabaja poco",
      "Me invitan a comentar y me bardean. Soy el Alberto de siempre: pongo la cara y me pegan",
      "El cumpleañero me tira con Milei. Yo le tiro con Fabiola... ah no, mejor no",
      "Que lindo que el Doctor festeje su cumpleaños conmigo. Lástima que yo no lo elegí a él",
    ]),
    taunt: (n) => pick([
