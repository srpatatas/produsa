...
const VOICES: Record<string, PersonalityVoice> = {
  ...
  "SF": { // El Gato — Macri en Disney, Aristogatos, tibio arrepentido
    ...
    comodinExactHit: (n, h, a) => pick([`¡${n} CLAVÓ el ${h}-${a}! Eso no es gradualismo, eso es quirúrgico. Te contrato para la próxima campaña`, `¡Exacto de ${n}! ${h}-${a}. Se empiezan a ver resultados, como en mi segundo semestre`, `¡${n} le pegó justo al ${h}-${a}! Más preciso que todas mis promesas de campaña juntas. Y fueron muchas`]),
    ...
    idle: () => pick([
      ...
      "Los pobres de hoy viven mejor que un rey de hace 100 años",
      "Si le das la tarjeta a tu mujer, ella gasta y gasta y un día van y te hipotecan la casa",
    ...
    taunt: (n) => pick([
      `${n}, venías bien pero de golpe pasaron cosas`,
      `${n}, yo también fui optimista sin datos. Se llama "sí se puede" y no se pudo`,
      `¿En qué te has transformado, ${n}? No dejás de pronosticar mal`,
    ...
    lecture: {
      ...
      ESP: [
        ...
        "El tiki-tiki es la versión futbolística del gradualismo: parece que avanza pero a veces te dormís mirándolo",
        "España ganó el mundial del 2010 jugando como yo goberné: con paciencia. La diferencia es que a ellos les alcanzó. A mí no",
        "Los españoles ponen veinte bares por cuadra y viven bien. En Argentina ponés un bar y te lo regulan, te lo inspecciona AFIP y te lo clausuran",
      ...
      ARG: [
        "Messi y yo tenemos algo en común: los dos fuimos incomprendidos en Argentina. Después nos quisieron, pero tarde",
        "Yo quiero que Argentina gane. Pero si gana, alguno va a decir que es mérito del gobierno de turno. A mí me tocó la Copa América 2016 y nadie me la atribuyó",
        "La Selección tiene algo que mi gobierno no tuvo: un vestuario unido. Yo tenía un gabinete donde cada ministro jugaba para su propia selección",
        "La selección tiene el mejor equipo de los últimos 50 años. Como mi gabinete",
  ...
  "FINAL": { // El Profesor — Pablo F, the anti-pronóstico, tribute comodín
    ...
    idle: () => pick([
      ...
      "Puse todo de mí. Incluso 50 lucas y ahora otras 25. Ojalá me tocara estar en la cancha",
      ...
      "Llorando y abrazado a mi hija que también lloraba. Estoy hecho. Pero hoy hay que dar un poco más",
      ...
      "Y si, el Profe hizo su magia. No pregunten cómo. El Profe no revela sus métodos",
      "Solicito recurso de amparo para colocar ganador al rival de Argentina ya que es la final y hay que asegurar",
    ]),
    taunt: (n) => pick([
    ...
    lecture: {
      ARG: [
        "Argentina juega y yo apuesto en contra. Suena loco pero funciona. Pregunten en el grupo: cada vez que puse Visitante, Argentina ganó. No es casualidad, es el poder del Profe",
        "Tranqui, la cago en cualquier momento. Pero ustedes cuentan con los 8 puntos a favor de Argentina que yo tengo que hacer mi magia y perder",
        "A Messi lo banco desde que era pibe. La diferencia es que yo lo banco apostando en contra. Es la forma más pura de amor: sacrificar tus puntos por tu selección",
