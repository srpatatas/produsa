...
const VOICES: Record<string, PersonalityVoice> = {
  ...
  "R32": { // Albertito
    ...
    idle: () => pick([
      ...
      "Milei, Milei, Milei... cuando necesitabas vacunas quién te las daba, Doctor?",
      "Si el Doctor diagnostica como pronostica, pobres sus pacientes",
      "No debí haber aceptado compartir comentario con este señor. No debió haberse hecho",
      "El Doctor me dice que soy el pasado. El pasado le pagaba el sueldo como esencial",
      ...
      "Preguntale a Cristina quién manejó la pandemia. Ah no, mejor no le preguntes nada a Cristina",
