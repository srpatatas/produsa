    ...
    <div className="w-full overflow-x-auto pb-4">
      <div className="min-w-[1000px] relative">
        ...
        <div className="grid grid-cols-9 gap-1 px-1" style={{ minHeight: "800px" }}>
          ...
          {/* Center: just trophy + champion label */}
          <div className="flex flex-col items-center justify-center">
            ...
            {(() => {
              ...
              return (
                <div className="rounded-lg ring-1 ring-fifa-gold/30 bg-fifa-gold/[0.05] px-3 py-1.5 mb-3 flex items-center gap-2">
                  {winner ? (
                    <>
                    ...
                    <span className="text-[10px] text-fifa-dark-gray/30">?</span>
                  )}
                </div>
              );
            })()}
        ...
        {/* Final + 3P below bracket */}
        <div className="flex items-start justify-center gap-8 mt-4">
          <div className="text-center">
            <p className="text-[8px] uppercase tracking-wider text-fifa-gold/60 mb-1">Final</p>
            <MatchCard match={matchMap.get("F")!} resolved={resolvedMap["F"]} result={resultMap["F"]} large />
          </div>
          <div className="text-center opacity-50">
            <p className="text-[8px] uppercase tracking-wider text-fifa-dark-gray/40 mb-1">3er puesto</p>
