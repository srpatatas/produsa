    ...
    <div className="mx-auto max-w-md rounded-2xl bg-card-bg shadow-sm shadow-black/20 ring-1 ring-white/5 overflow-hidden">
      ...
      <div className="border-t border-white/5 px-5 py-4">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          ...
          {Date.now() >= Date.UTC(2026, 5, 19, 7, 0, 0) && (
            <Link href="/frogusa" className="group flex flex-col items-center gap-1.5">
              <div className="flex h-14 w-14 items-center justify-center rounded-[16px] bg-gradient-to-br from-teal-500 via-green-400 to-lime-400 shadow-md shadow-teal-500/30 transition-all duration-200 group-hover:scale-110 group-active:scale-90">
                <span className="text-2xl transition-transform duration-200 group-hover:-rotate-6">🐸</span>
              </div>
          ...
          {Date.now() >= Date.UTC(2026, 5, 20, 7, 0, 0) && (
            <Link href="/trivia" className="group flex flex-col items-center gap-1.5">
              <div className="flex h-14 w-14 items-center justify-center rounded-[16px] bg-gradient-to-br from-indigo-950 via-amber-600 to-indigo-950 shadow-md shadow-amber-500/30 transition-all duration-200 group-hover:scale-110 group-active:scale-90">
                <span className="text-2xl transition-transform duration-200 group-hover:-rotate-6">💰</span>
              </div>
          ...
          {Date.now() >= Date.UTC(2026, 5, 22, 20, 0, 0) && (
            <Link href="/triompy" className="group flex flex-col items-center gap-1.5">
              <div className="flex h-14 w-14 items-center justify-center rounded-[16px] bg-gradient-to-br from-blue-800 via-indigo-700 to-blue-900 shadow-md shadow-blue-500/30 transition-all duration-200 group-hover:scale-110 group-active:scale-90">
                <span className="text-2xl transition-transform duration-200 group-hover:-rotate-6">🏀</span>
              </div>
              <span className="whitespace-nowrap text-[10px] font-semibold text-fifa-dark-gray" style={{ fontFamily: "var(--font-playful)" }}>Triompy</span>
            </Link>
          )}
        </div>
      </div>
