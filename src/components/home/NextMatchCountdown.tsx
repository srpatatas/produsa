        ...
        <div className="flex flex-wrap justify-center gap-5">
          ...
          {Date.now() >= Date.UTC(2026, 5, 18, 7, 0, 0) && (
            <Link href="/flappy" className="group flex flex-col items-center gap-1.5">
              <div className="flex h-14 w-14 items-center justify-center rounded-[16px] bg-gradient-to-br from-sky-400 via-blue-400 to-cyan-500 shadow-md shadow-sky-400/30 transition-all duration-200 group-hover:scale-110 group-active:scale-90">
                <span className="text-2xl transition-transform duration-200 group-hover:-rotate-6">⚽</span>
              </div>
