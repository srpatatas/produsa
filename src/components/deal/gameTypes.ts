...
export const BANKERS: BankerConfig[] = [
  ...
  // Albertito Disney — out-of-touch, blames everyone, Disney escapist
  {
    ...
    offer: {
      smug: [
        ...
        "La oferta era más alta pero hubo que pagar Disney...",
      ...
      neutral: [
        ...
        "Esta oferta la veo desde el castillo de Disney...",
      ...
      desperate: [
        ...
        "¡Mirá esa oferta! ¡Ni en Disney te dan algo así!",
    ...
    noDeal: {
      smug: [
        ...
        "No me preocupa para nada, estoy de vacaciones en Disney",
        "Seguí, seguí... total después le echo la culpa a otro",
        "Me quedo tranquilo desde Orlando",
    ...
    deal: {
      ...
      neutral: [
        ...
        "Deal cerrado, a disfrutar... yo me voy a Disney",
        "Te llevás una linda suma, felicitaciones desde Orlando",
      ...
      desperate: [
        ...
        "¡No puedo creer que te llevás eso! ¡Ni en Disney gasto tanto!",
