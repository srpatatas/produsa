  ...
  // El Profe Alfiki — convoluted philosopher, everything is a metaphor
  {
    ...
    offer: {
      ...
      neutral: [
        ...
        "El resistir está grabado en nuestra cédula de identidad. ¿Vas a resistir o vas a aceptar?",
        ...
        "Venimos de la tierra colorada. Esta oferta viene del corazón",
      ...
      desperate: [
        ...
        "¡A la mesa entraron números y salieron leyendas! ¡Esta oferta es legendaria!",
        "¡Tenemos un corazón que no se rinde! ¡Y una oferta que no se baja!",
        "¡Éramos Bruce Willis! ¡Los únicos que sabíamos que esta oferta era buena éramos nosotros!",
        ...
        "¡Es la oferta más grande de mi vida! ¡Una mezcla de sangre y épica!",
      ],
    },
    noDeal: {
      smug: [
    ...
    deal: {
      ...
      neutral: [
        ...
        "Buen deal. El resistir está grabado en tu cédula, pero a veces hay que soltar",
        "No es lo que parece, es lo que uno interpreta. Y vos interpretaste bien",
        "Te vas con la tierra colorada en el bolsillo. Bien jugado",
        "Yo no muero con la mía, vivo con la mía. Y vos vivís con este deal",
      ],
      desperate: [
        ...
        "¡Me da vergüenza cuánto te llevás! ¡Cuando me pasan todas juntas...!",
