...
const EASY: Question[] = [
  ...
  { q: "¿Qué país ganó el primer Mundial europeo en 1934?", options: ["Alemania", "Italia", "España", "Francia"], answer: 1, hint: "Como local, en plena era de Mussolini" },
  ...
  { q: "¿En qué Mundial jugó Diego Maradona su último partido?", options: ["Italia 1990", "USA 1994", "Francia 1998", "México 1986"], answer: 1, hint: "Fue suspendido por doping durante el torneo" },
  { q: "¿Qué selección hizo el famoso 'tiki-taka' para ganar el Mundial 2010?", options: ["Alemania", "Brasil", "España", "Países Bajos"], answer: 2, hint: "Xavi e Iniesta eran los motores" },
