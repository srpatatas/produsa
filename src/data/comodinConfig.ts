...
export const comodinConfigs: Record<string, ComodinConfig> = {
  ...
  "SF": {
    ...
    phrases: [
      ...
      "Elegí bien, no como los argentinos en 2019 que votaron por Alberto",
      "En Boca gané 17 títulos con planificación. En la presidencia fui gradualista y me fueron",
      "Sí se puede, decíamos. No se pudo. Pero el comodín sí se puede",
      ...
      "¿Tu vieja bien? ¿Qué opina? Preguntale a ella dónde poner el comodín",
    ],
  ...
  "FINAL": {
    ...
    phrases: [
      ...
      "Puse todo de mí. Incluso 50 lucas. Si Argentina gana hoy, no fue suerte: fue sacrificio",
      ...
      "Los históricos saben: lo que el Profe vota ganador, pierde. Lo que vota perdedor, gana. Hoy voté perdedora a Argentina. De nada",
