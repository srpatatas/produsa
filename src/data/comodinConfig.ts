...
export const comodinConfigs: Record<string, ComodinConfig> = {
  ...
  "R16": {
    ...
    phrases: [
      ...
      "Como decía Einstein, es mucho más fácil desactivar un átomo que un preconcepto. Y el preconcepto de que no vas a poner el comodín es el átomo que hay que desactivar",
      "Venimos de la tierra colorada. Esa tierra que está en las franjas de nuestra camiseta. El comodín es nuestra bandera",
      "Éramos Bruce Willis en Sexto Sentido: los únicos que sabíamos que no estábamos muertos éramos nosotros. Poné el comodín y reviví",
      "Las victorias sirven para reafirmar las convicciones. Y la convicción de este momento es que el comodín va acá",
      "Hay que bailar la música que te ponen. A veces es cumbia, a veces tango, a veces polca. Hoy la música dice: comodín",
      "Yo no muero con la mía, vivo con la mía. Y vivir es cambiar. Si tengo que cambiar el comodín de partido, lo cambio",
      "El resistir está grabado en nuestra cédula de identidad. Resistí la tentación de no poner el comodín",
    ],
    placementPhrase: "La manera de crecer es nivelarte para arriba. Y para nivelarte, hay que elegir un partido...",
    rejectPhrases: [
      "¡Ahí no! Cuando se pone la carreta delante del caballo es muy difícil avanzar",
      ...
      "¡Ese no! Estamos remando en dulce de leche con ese partido. Buscá otro",
    ],
  },
