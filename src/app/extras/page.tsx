...
const SECTIONS = [
  ...
  { title: "Eliminatorias", icon: "🥊", ids: ["golestotales-16vos", "posesion-caboverde", "pases-marruecos", "ck-francia", "tarjetas-octavos", "faltas-franciamarruecos", "offsides-belgicaspain", "goles-cuartos", "remates-espfra", "faltas-argeng", "corners-semis", "pases-completados-final", "posesion-franing", "amonestados-fasefinal"], gradient: "from-indigo-600 via-violet-600 to-purple-700" },
];
